...
public class TrafficCycleArrowR2 : TrafficCycle {
	...
	//車灯用の時間
	//方向1青時間、方向2青時間、方向1矢印時間、黄時間(1)(2)、全赤時間
	public float greenTime1, greenTime2, arrowTime1, yellowTime, yellowTime2, allRedTime;
	//歩灯用の時間
